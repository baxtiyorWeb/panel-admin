        ...
        <div className="top_chart">
          <div className="block">
            <div className="dev">
              ...
              <span className="word">
                ...
                <span className="dunn">100%</span> Since last month
              </span>
            </div>
            <div className="dev_2">
          ...
          <div className="block">
            <div className="dev">
              ...
              <br />
              <span className="word">
                <AiOutlineArrowUp className="arrow_color" />{" "}
                <span className="dunn_rock">100%</span> Since last month
              </span>
            </div>
            <div className="dev_3">
          ...
          <div className="block">
            <div className="dev">
              ...
              <span className="word">
                <AiOutlineArrowUp className="arrow_color" />{" "}
                <span className="dunn_rock">1</span> Last month enrolled
              </span>
            </div>
            <div className="dev_4">
