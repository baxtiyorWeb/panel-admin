...
const Layout = () => {
	...
	return (
			<div className="flex flex-col min-h-screen overflow-hidden dark:bg-[#3B4452]" >
				<Header
					colors={colors}
					setColor={setColor}
				...
				<div className="grow">
					...
					<div
						...
						className={'w-[15%] h-[100vh] bg-white shadow-[1px_10px_5px_3px_#221] fixed  dark:bg-[#353C48]'}
