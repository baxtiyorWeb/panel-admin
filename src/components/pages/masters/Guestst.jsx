...
const Guestst = () => {
    ...
    >
        <div className="div-block dark:bg-[#353C48] dark:border dark:border-[#3b4452]">
            ...
            <div
                style={{
                    width: "90%", marginTop: "10px", marginBottom: "40px",
                }}
            ></div>
        ...
        <div
            style={{
                width: "65%", boxShadow: " 0px 4px 8px 0px rgba(34, 60, 80, 0.2)",
            }}
        >
            <div
                className="around_one dark:border-b dark:border-b-[#3b4452] mb-5"
                style={{
                    borderBottom: "1px solid #E1E1E1", paddingBottom: "23px",
                }}
            >
                    ...
                    <div>
                        <div className="table-responsive-vertical shadow-z-1">
                            ...
                            >
                                ...
                                <tbody>
                                {data.filter((users) => users.add_guests.toLowerCase().includes(search)).map((item, index) => {
                                    return (<tr
                                        key={item.id}
