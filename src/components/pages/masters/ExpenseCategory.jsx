...
import {useExpenseCategory} from "../../../hooks/useExpenseCategory.js";

const ExpenseCategory = () => {
    const courses = useExpenseCategory()
    return (<div>
        <div
                ...
                <div>
                    {courses.modal ? <input type="text" placeholder={'edit'} value={courses.addCourse || ""}
                        ...
                        <input type="text" placeholder="add course title" className={'dark:bg-transparent'}
                               onChange={(e) => courses.setAddCourse(e.target.value)} value={courses.addCourse || ""}/>}
                </div>
                <div>
