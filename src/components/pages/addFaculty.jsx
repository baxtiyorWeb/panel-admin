            ...
            <div className="input-box">
                ...
                <div>
                    ...
                    <div>
                        <div className={'flex items-center mb-[3px]'}>
                            <label htmlFor="male" className={'mr-[5px] ml-[0px]'}>male</label>
                            <input
                                id={'male'}
                                name={'label'}
                                type="radio"
                        ...
                        <div className={'flex items-center'}>
                            <label htmlFor="female" className={'mr-[5px] ml-[0px]'}>female</label>
                            <input
                                id={'female'}
                                name={'label'}
                                type="radio"
                ...
                <div className="name">
                    ...
                    <textarea cols="30" rows="10"
                              className={'w-full h-[64px] border border-blue-600 dark:bg-[transparent] rounded-[5px] p-[10px] fz-[18px] tracking-normal'}></textarea>
                </div>
                <div className="name">
                    <span>Course</span>
                    <select
                ...
                <div className="name">
                    ...
                    <input type="text" placeholder={'qualification'} className="dark:bg-[#353C48] dark:border"/>
